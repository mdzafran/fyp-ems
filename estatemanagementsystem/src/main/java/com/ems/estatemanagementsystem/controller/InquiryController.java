        ...
        try {
            ...
            for(i = 0; i < agencyIds.size(); i++) {
                ...
                String emailBody = "Dear " + agencyName + ",\n\n"
                                ...
                                + "I am writing to inquire about the existence of estates for " + inquiry.getInquiryFor() + " of " + user.getName() + " (" + user.getIDNum() + ")\n\n"
                                ...
                                + "Best regards,\n\n"
                                + "EMS Agency";
                String subject = "Inquiry Regarding the Estates for the " + inquiry.getInquiryFor() + " of " + user.getName() + " (" + user.getIDNum() + ")"; 
